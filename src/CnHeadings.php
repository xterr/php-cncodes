...
class CnHeadings extends AbstractDatabase
{
    /**
    ...
    {
        parent::__construct($baseDirectory, CnHeading::class, $translator);
    }

    public function getByCodeAndVersion(string $code, int $version = CnVersion::VERSION_2024): ?CnHeading
    {
