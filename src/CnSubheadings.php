...
class CnSubheadings extends AbstractDatabase
{
    /**
    ...
    {
        parent::__construct($baseDirectory, CnSubheading::class, $translator);
    }

    public function getByCodeAndVersion(string $code, int $version = CnVersion::VERSION_2024): ?CnSubheading
    {
