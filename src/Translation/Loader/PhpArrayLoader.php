...
namespace Xterr\CnCodes\Translation\Loader;
...
final class PhpArrayLoader implements TranslationLoaderInterface
{
     ...
     * {@inheritdoc}
     */
    public function load(string $locale, string $domain = 'cnCodes'): array
    {
     ...
     * {@inheritdoc}
     */
    public function supports(string $locale, string $domain = 'cnCodes'): bool
    {
        return in_array(
     ...
     * {@inheritdoc}
     */
    public function getAvailableLocales(string $domain = 'cnCodes'): array
    {
