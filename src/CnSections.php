...
class CnSections extends AbstractDatabase
{
    /**
    ...
    {
        parent::__construct($baseDirectory, CnSection::class, $translator);
    }

    public function getByCodeAndVersion(string $code, int $version = CnVersion::VERSION_2024): ?CnSection
    {
