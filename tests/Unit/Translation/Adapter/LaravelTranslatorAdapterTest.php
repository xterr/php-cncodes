...
#[\PHPUnit\Framework\Attributes\RequiresFunction('interface_exists')]
class LaravelTranslatorAdapterTest extends TestCase
{
    ...
    public function testTranslateDelegatesToLaravelTranslator(): void
    {
        ...
        $laravelTranslator
            ->expects($this->once())
            ->method('get')
            ->with('cncodes::cnCodes.Some text', [], 'en')
    ...
    public function testTranslatePassesLocaleToLaravelTranslator(): void
    {
        ...
        $laravelTranslator
            ->expects($this->once())
            ->method('get')
            ->with('cncodes::cnCodes.Some text', [], 'de')
    ...
    public function testCustomNamespace(): void
    {
        ...
        $laravelTranslator
            ->expects($this->once())
            ->method('get')
            ->with('custom::cnCodes.Some text', [], 'en')
